  ...
  <li><button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in"></span>Login</button></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal col-sm-8" id="signupform" action="/Ghumaghumalu/SignUp" method="get">
        ...
        <header class="jumbotron row-header">
          ...
          <div class=container>
            <div class="row row-content">
              ...
              <div class="row">
                ...
                <a href="#reserve">
                <button  type="button" class="btn btn-info btn-lg">Reserve a Table
                </button>
                </a>
                </div>
                </div>
            ...
            <div class="container">
              <div class="row row-content">
                ...
                <div class="row row-content">
                <div id="reserve" class="col-xs-6">
                <h2 style="padding:90px">Reserve a Table</h2>
                </div>
                <div class="col-xs-6">
                <form action="/Ghumaghumalu/Reserve" method="get">
                 <div class="form-group">
  				...
  				<div class="form-group">
   					 <font style="font-size:20px">Couple:</font>
       			 		<input type="radio" class="form-check-input" id="coupleYes" name="couple" value="yes">
       			 	    <font style="font-size:16px">Yes</font>

       			 		<input type="radio" class="form-check-input" id="coupleNo" name="couple" value="no">
       			 		<font style="font-size:16px">No</font>
       			 		
    			</div>
    			<div id="guestsNo" class="form-group">
    			<font style="font-size:20px">Number of Guests:</font>
    			
    			<input class="form-control" type="number" name="guestNo" placeholder="Enter a Number">
  				</div>
				...
				<input type="submit" id="btn" class="btn btn-info btn-lg" value="Submit">
          ...
          <!--       <script>
                $(document).ready(function() {
                    $("input[name$='couple']").click(function() {
                        var test = $(this).val();
		...
		<script type="text/javascript">
  		...
  		var output=document.getElementById('outputbox1');
  		btn.addEventListener("click",function(){
   		x.open('GET','/Ghumaghumalu/ReserveSubmit');
   		x.onload=function(){
...
function printname(data){
  output.insertAdjacentHTML('beforeend',data.message);
}
...
var pass= document.getElementById("password").value;
$.ajax( {
>>>>>>> 66c6fb2d1af4471199feafb03c760280edda3de5
	url: ur,
	type: 'get',
